...
title: "Pague pelos 20% que você realmente usa: como reduzir o parque de apps Atlassian sem perder o fluxo"
...
A maioria dos times descobre o custo do seu parque de apps Atlassian do mesmo jeito que descobre toda dívida operacional. Quando dói, já estava doendo faz tempo.
...
## Como auditar o seu próprio parque de apps
...
Alguns apps você mantém. O Marketplace é cheio de fornecedores excelentes, e reconstruir uma ferramenta robusta só para economizar é um mau negócio. A gente fala isso quando essa é a resposta.
...
Os números reais que colocamos na sua frente saem da sua auditoria, não da nossa página de marketing. São baseados no seu número de licenças, nos seus apps, nos seus contratos.
