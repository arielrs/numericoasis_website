...
title: "Cómo elegir una app de control de costes para Jira"
...
author: team
heroImage: ../../../assets/blog/how-to-choose-a-cost-tracking-app-for-jira.jpg
heroImageAlt: 'Tarjeta de título en inglés, "Which Jira Cost Tracking App? 6 Questions to Ask", con una lupa que destaca la tarjeta de app central, sobre una fila de seis criterios.'
draft: false
---
...
Antes de nada: nosotros hacemos [OnBudget](/es/onbudget/), una app de Jira Cloud para control de presupuesto e informes de costes. Estás leyendo una guía de compra escrita por un proveedor, así que ponderala en consecuencia. Los criterios de abajo se aplican a todas las opciones de tu lista, incluida la nuestra, y allí donde OnBudget no cumple uno, queda dicho con las mismas palabras que todo lo demás.
