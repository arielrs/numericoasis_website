export const en = {
  ...
  lede: 'Every one runs on Forge inside your own Atlassian environment, so your data stays where it already is, your security review covers one platform you have already approved, and updates arrive without a maintenance window.',
  groups: {
    jira: 'For Jira',
