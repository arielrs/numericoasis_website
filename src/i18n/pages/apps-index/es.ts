...
export const es = {
  ...
  lede: 'Todas funcionan sobre Forge dentro de tu propio sitio de Atlassian, así que tus datos se quedan donde ya están, no hay servidor de proveedor que seguridad tenga que aprobar, y las actualizaciones llegan sin ventana de mantenimiento.',
  groups: {
    jira: 'Para Jira',
