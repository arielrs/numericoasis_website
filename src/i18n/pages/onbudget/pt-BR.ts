...
export const ptBR = {
  ...
  fit: {
    ...
    items: [
      ...
      'Roda no Jira Cloud, construído em Atlassian Forge. Data Center e Server não são suportados.',
      'Pronto assim que instala. Ele lê os campos, status e worklogs que o seu Jira já tem.',
    ],
  },
