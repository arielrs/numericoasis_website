export const en = {
  ...
  proof: {
    ...
    items: [
      ...
      'Your security review stays inside Atlassian',
  ...
  focus: {
    ...
    lede: 'Budget versus actual, health and forecast, built from the work your team already tracks in Jira. Delivery, product and marketing budgets side by side, each in its own currency, and it works with the fields your team already fills in.',
    custom: {
  ...
  how: {
    ...
    paragraphs: [
      'Every app we publish runs on Atlassian Forge, so the code executes inside Atlassian infrastructure and your data stays in your own Atlassian environment. That answers most of a security review before it starts: your reviewer assesses one platform they have already approved, and the uptime you depend on is the one you already depend on.',
