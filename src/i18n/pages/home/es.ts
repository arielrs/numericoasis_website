...
export const es = {
  meta: {
    ...
    description:
      'Numeric Oasis es socia en el Atlassian Marketplace y construye apps en Forge para Jira y Confluence Cloud. OnBudget convierte el trabajo ya registrado en Jira en presupuestos, pronósticos e informes de costo, y cada app que publicamos funciona dentro de tu propio sitio de Atlassian.',
  },
  hero: {
    eyebrow: 'Socia en el Atlassian Marketplace',
    headline: 'Las apps de Atlassian que siempre quisimos que existieran.',
    lede: 'Quince años dentro de Jira y Confluence nos enseñaron qué tienen que esquivar los equipos todos los días. Ahora construimos las apps que hacen ese trabajo por ellos, y cada una funciona dentro de tu propio sitio de Atlassian.',
  ...
  how: {
    ...
    headline: 'Todo lo que construimos funciona dentro de tu propia Atlassian.',
    paragraphs: [
      'Cada app que publicamos funciona sobre Atlassian Forge, así que el código se ejecuta dentro de la infraestructura de Atlassian y tus datos se quedan en tu propio sitio de Atlassian. Eso responde la mayor parte de una revisión de seguridad antes de que empiece: no hay un host de terceros que evaluar, no hay nada saliendo de Atlassian que documentar, y no hay un tiempo de actividad aparte del que depender.',
